    ...
    <div className="space-y-4">
      ...
      {resultado.tipo === 'parcelado' && resultado.parcelas.length > 0 && (
        <>
          ...
          <ParcelasTable parcelas={resultado.parcelas} serie={serie} benchmarkNome={benchmark.nome} cenarioNome={cenario.nome} corretagem={cenario.corretagem} ir={cenario.ir} />
        </>
      )}
